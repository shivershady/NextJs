...
function Index(props) {
  ...
  carts.forEach(function (prod) {
    setSubTotal(prod.price * prod.quantity + subTotal);
...
_s(Index, "omtTlA94875+tKWdAizNpbn84oU=");
