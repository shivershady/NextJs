                      ...
                      children: (product.filters || []).map(function (filter, index) {
                        return /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxDEV"])("div", {
                          ...
                          children: /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxDEV"])("span", {
                            ...
                            children: [filter.name, ":", filter.childs.map(function (child, index) {
                              // (product.currentFilter || []).map((currentFilter, index) => {
                              //     if (currentFilter.id == child.id) {
                              //         console.log('dsfasd');
                              //         return (
                              //             <span key={index}
                              //                   className="text-sm dark:text-gray-400 text-gray-300">{child.name}</span>
                              //         )
                              //     }
                              // })
                              return /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxDEV"])("div", {
