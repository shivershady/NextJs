...
function Index(props) {
  ...
  carts.forEach(function (prod) {
    setSubTotal((prod === null || prod === void 0 ? void 0 : prod.price) * prod.quantity + subTotal);
  });
